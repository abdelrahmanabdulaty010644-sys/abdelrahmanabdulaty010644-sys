...
- 📦 [Amazon Product Reviews Analytics](https://github.com/abdelrahmanabdulaty010644-sys/proudect-review-analysis) - Advanced Power BI data-quality project analyzing a massive 1.5M row Amazon dataset ($161M revenue). Engineered custom DAX logic to isolate unverified ratings (high stars with zero text reviews), shifting the business narrative and revealing that the Girl’s Clothing sector drove genuine, verified revenue growth.
